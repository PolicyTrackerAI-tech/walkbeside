...
8. **FAMILY-INITIATED ONLY** — Can any flow here result in the platform cold-contacting a next of kin, or a hospice transmitting patient/family data to us? Must be NO (at-need solicitation banned FL/TX/ME/NE; HIPAA-by-construction). *(channel-survival rules)*
