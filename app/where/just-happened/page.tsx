...
/**
 * Screen 2b — drill-down for the "it just happened" path. The 4
 * location-specific scenarios route into /guidance/[scenario].
 */
...
export default function WhereJustHappenedPage() {
  return (
    <main className="flex-1 flex flex-col">
      <SiteHeader
        rightSlot={<BackLink defaultHref="/where" defaultLabel="← Back" />}
      />
      ...
      <section className="flex-1">
        <div className="max-w-2xl mx-auto px-5 py-12">
          ...
          <p className="text-ink-soft mb-6">
            This tells us what to help with first.
          </p>
