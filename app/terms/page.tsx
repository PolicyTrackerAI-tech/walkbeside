...
export const metadata = {
  title: "Terms",
  description:
    "The terms for using Honest Funeral. Free tools are free. The flat $249 advocate fee only applies if you choose a funeral home we present.",
};
      ...
      <section className="flex-1">
        <article className="max-w-2xl mx-auto px-5 py-10 space-y-6 text-ink-soft">
          ...
          <h2 className="font-serif text-xl text-ink pt-4">
            1. What Honest Funeral is &mdash; and is not
          </h2>
          <p>
            Honest Funeral is a consumer-facing information and advocacy service
            built to help families navigate funeral arrangements and
            post-death administration. Honest Funeral is <strong>not</strong> a
          ...
          <p>
            ...
            from users. Actual prices vary by firm and by date. Honest Funeral does
          ...
          <p>
            ...
            accuracy before publishing or relying on them. Honest Funeral is not
          ...
          <p>
            Any dispute between you and Honest Funeral arising out of or relating
          ...
          <p>
            You agree to indemnify and hold Honest Funeral harmless from claims
