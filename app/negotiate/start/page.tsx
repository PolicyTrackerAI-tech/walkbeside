        ...
        <div className="max-w-2xl mx-auto px-5 py-10 space-y-6">
          <div>
            ...
            <p className="text-lg text-ink-soft">
              We&rsquo;ll contact 3–5 funeral homes in your area on your behalf —
              anonymously — and bring you back the best two or three options.
            </p>
          </div>
          ...
          <Card tone="primary">
            ...
            <ol className="space-y-2 list-decimal list-inside text-ink">
              ...
              <li>
                We email a few funeral homes asking for itemized prices — no
                pressure, no commitment.
              </li>
              <li>
                As replies come in, we put them side-by-side for you. You pick
                the home you want.
              </li>
              <li>
            ...
            <form onSubmit={start} className="space-y-5">
              <div className="grid sm:grid-cols-2 gap-5">
                ...
                <div>
                  <Label
                    htmlFor="home"
                    hint="Optional. We'll baseline against this."
                  >
                ...
                <div>
                  <Label
                    htmlFor="q"
                    hint="Optional. The all-in number they quoted."
                  >
              ...
              <Button type="submit" disabled={busy} size="lg">
                {busy ? "Reaching out…" : "Start outreach"}
              </Button>
