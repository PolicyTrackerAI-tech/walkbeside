...
const NEG_COLS =
  "id, zip, service_type, status, target_home_estimate_cents, best_quote_cents, negotiated_price_cents, amount_paid_cents, satisfaction_score, savings_vs_listed_cents, outcome_recorded_at, fee_cents, created_at";
const OUTREACH_COLS =
