...
${brandFooterText(email)}`;
  ...
  <div style="max-width: 480px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; padding: 40px 32px;">
    ...
    <p style="font-size: 16px; line-height: 1.65; color: #4a4a4a; margin: 0 0 16px 0;">Quick note in case it's useful. We help families compare funeral homes before they sign anything. The gap between fair and inflated pricing on the same arrangement runs $2,000 to $5,000 — comparing before you sign is how families stay on the right side of it.</p>
...
Quick note in case it's useful. We help families compare funeral homes before they sign anything. The gap between fair and inflated pricing on the same arrangement runs $2,000 to $5,000 — comparing before you sign is how families stay on the right side of it.
