...
${brandFooterText(email)}`;
  ...
  <div style="max-width: 480px; margin: 0 auto; background-color: #ffffff; border-radius: 16px; padding: 40px 32px;">
    ...
    <p style="font-size: 16px; line-height: 1.65; color: #4a4a4a; margin: 0 0 16px 0;">A flat $49, paid upfront before we contact any home. Refundable in 14 days if we didn't save you anything. We take no commissions or kickbacks from any funeral home — your $49 is our only revenue.</p>
...
A flat $49, paid upfront before we contact any home. Refundable in 14 days if we didn't save you anything. We take no commissions or kickbacks from any funeral home — your $49 is our only revenue.
